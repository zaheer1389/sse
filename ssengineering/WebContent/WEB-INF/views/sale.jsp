...
<body>
	<div class="site-container">
		...
		<div class="content">					
			<div class="jtable-main-container">
				<div class="jtable-title">
					<div class="jtable-title-text">Sale List</div>
		...
		<div id="view-dialog" title="Sale Details">
		...
		<div id="edit-dialog" title="Edit Sale">
		...
		<div id="add-dialog" title="Add Sale">					
	...
	<script type="text/javascript">
		...
		function setEvents(){
			...
			$('#itemTable').on('change', 'input[id^=deleted]' ,function(event){
			    ...
			    var row = $this.closest("tr");			    
			    $(row).remove();	
			    $("#formEdit input[name=totalItems]").val($("#itemTable tbody").children().length);			    			   
			});
