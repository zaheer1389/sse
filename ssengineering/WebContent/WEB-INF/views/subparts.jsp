...
<body>
	<div class="site-container">
		...
		<div class="content">					
			<div class="jtable-main-container">
				<div class="jtable-title">
					<div class="jtable-title-text">SubParts List</div>
		...
		<div id="edit-dialog" title="Edit SubPart">
		...
		<div id="add-dialog" title="Add SubPart">			
			<form:form method="post" action="add" commandName="subpart" id="formAdd">
				<div>
	...
	<script type="text/javascript">
		...
		$('#jtable').on('click', '.edit-dialog-link' ,function(event){
			...
			$.ajax({
			     ...
			     success : function(response) {
			    	 ...
			    	 $("#formEdit select[name=partId]").val(obj.part.partid);
		...
		function validateAddForm(){	
			if($('#formAdd select[name=partId]').val() == -1){
				$('#addFormErrorText').html("Please select part");
				return;
			}
			else if($('#formAdd input[name=name]').val().length == 0){
				$('#addFormErrorText').html("Please enter subpart name");
				return;
			}
			else if($('#formAdd input[name=description]').val().length == 0){
				$('#addFormErrorText').html("Please enter subpart description");
				return;
			}
		...
		function validateEditForm(){
			if($('#formEdit select[name=partId]').val() == -1){
				$('#editFormErrorText').html("Please select part");
				return;
			}
			else if($('#formEdit input[name=name]').val().length == 0){
				$('#editFormErrorText').html("Please enter subpart name");
				return;
			}
			else if($('#formEdit input[name=description]').val().length == 0){
				$('#editFormErrorText').html("Please enter subpart description");
				return;
			}
